    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm p-10 border border-gray-200 text-center">
          <p className="text-gray-900 font-medium mb-2">لا توجد محافظ</p>
          <p className="text-sm text-gray-600">سيتم عرض المحافظ هنا عند تفعيل نظام المحافظ وربطه بقاعدة البيانات.</p>
        </div>
      </div>
    </div>
  );
