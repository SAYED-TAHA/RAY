...
import { fetchSecurityEvents, fetchSecuritySettings, SecuritySettings } from '../../../services/auditService';
...
export default function AdminSecurity() {
  ...
  const loadData = async () => {
    try {
      ...
      setSecurityEvents((eventsRes?.events || []) as LocalSecurityEvent[]);
    } catch (e) {
                  ...
                  <div key={event.id} className="flex items-center gap-3 p-3 rounded-lg bg-gray-50">
                    ...
                    <div className="flex-1">
                      <div className="text-sm font-medium text-gray-900">
                        ...
                        {event.type === 'permission_change' && 'تغيير صلاحيات'}
                      </div>
